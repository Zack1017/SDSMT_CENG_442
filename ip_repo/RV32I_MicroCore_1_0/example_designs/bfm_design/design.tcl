proc create_ipi_design { offsetfile design_name } {
	...
	set RV32I_MicroCore_0 [ create_bd_cell -type ip -vlnv user.org:user:RV32I_MicroCore:1.0 RV32I_MicroCore_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins RV32I_MicroCore_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/ACLK] [get_bd_pins RV32I_MicroCore_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/ARESETN] [get_bd_pins RV32I_MicroCore_0/S00_AXI_ARESETN]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:RV32I_MicroCore:1.0]]]]
