...
design_libs=(xil_defaultlib proc_sys_reset_v5_0_17 axi_bram_ctrl_v4_1_13 blk_mem_gen_v8_4_11)
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Lab3B.gen/sources_1/bd/design_1/ipshared/a9be" +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../Lab3B.gen/sources_1/bd/design_1/ipshared/a9be" +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/student/s101113328/CENG442/Lab3B/Lab3B.cache/compile_simlib/vcs"
  fi
