...
#
# Script generated by Vivado on Fri Oct 24 13:00:26 MDT 2025
...
design_libs_elab="-libname xil_defaultlib -libname proc_sys_reset_v5_0_17 -libname axi_bram_ctrl_v4_1_13 -libname blk_mem_gen_v8_4_11 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib proc_sys_reset_v5_0_17 axi_bram_ctrl_v4_1_13 blk_mem_gen_v8_4_11)
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Lab3B.gen/sources_1/bd/design_1/ipshared/a9be" +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../Lab3B.gen/sources_1/bd/design_1/ipshared/a9be" +incdir+"../../../../../../../../../opt/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/student/s101113328/CENG442/Lab3B/Lab3B.cache/compile_simlib/xcelium"
  fi
